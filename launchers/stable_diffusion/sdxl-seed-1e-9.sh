#!/bin/bash
#SBATCH --job-name=stable_diffusion-1e-9
#SBATCH --output=output/stable_diffusion-1e-9.out
#SBATCH --error=output/stable_diffusion-1e-9.err
#SBATCH --nodes=1
...
accelerate launch train.py \
  ...
  --output_dir="stable_diffusion-42-1e-9" \
  --seed 42 \
  --train_data_subdir 0
...
accelerate launch train.py \
  ...
  --beta_dpo 5000 \
   --sdxl  \
  --caption_csv_file /share/imagereward_work/prompt_reconstruction/data/blip2_flan.csv \
  --output_dir="stable_diffusion-167-1e-9" \
  --seed 167 \
  --train_data_subdir 0
...
accelerate launch train.py \
  ...
  --beta_dpo 5000 \
   --sdxl  \
  --caption_csv_file /share/imagereward_work/prompt_reconstruction/data/blip2_flan.csv \
  --output_dir="stable_diffusion-937-1e-9" \
  --seed 937 \
  --train_data_subdir 0