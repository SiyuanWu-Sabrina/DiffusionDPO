#!/bin/bash
#SBATCH --job-name=stable_diffusion-2e-10
#SBATCH --output=output/stable_diffusion-2e-10.out
#SBATCH --error=output/stable_diffusion-2e-10.err
#SBATCH --nodes=1
...
accelerate launch train.py \
  ...
  --beta_dpo 5000 \
   --sdxl  \
  --caption_csv_file /share/imagereward_work/prompt_reconstruction/data/blip2_flan.csv \
  --output_dir="stable_diffusion-167-2e-10" \
  --seed 167 \
  --train_data_subdir 0
