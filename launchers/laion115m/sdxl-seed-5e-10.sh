#!/bin/bash
#SBATCH --job-name=laion115m-5e-10
#SBATCH --output=output/laion115m-5e-10.out
#SBATCH --error=output/laion115m-5e-10.err
#SBATCH --nodes=1
...
accelerate launch train.py \
  ...
  --beta_dpo 5000 \
   --sdxl  \
  --caption_csv_file /share/imagereward_work/prompt_reconstruction/data/blip2_flan.csv \
  --output_dir="laion115m-167-5e-10" \
  --seed 167 \
  --train_data_subdir 0
...
accelerate launch train.py \
  ...
  --beta_dpo 5000 \
   --sdxl  \
  --caption_csv_file /share/imagereward_work/prompt_reconstruction/data/blip2_flan.csv \
  --output_dir="laion115m-937-5e-10" \
  --seed 937 \
  --train_data_subdir 0