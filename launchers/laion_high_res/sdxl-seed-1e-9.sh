#!/bin/bash
#SBATCH --job-name=laion_high_res-1e-9
#SBATCH --output=output/laion_high_res-1e-9.out
#SBATCH --error=output/laion_high_res-1e-9.err
#SBATCH --nodes=1
...
accelerate launch train.py \
  ...
  --output_dir="laion_high_res-42-1e-9" \
  --seed 42 \
  --train_data_subdir 0
...
accelerate launch train.py \
  ...
  --beta_dpo 5000 \
   --sdxl  \
  --caption_csv_file /share/imagereward_work/prompt_reconstruction/data/blip2_flan.csv \
  --output_dir="laion_high_res-167-1e-9" \
  --seed 167 \
  --train_data_subdir 0
...
accelerate launch train.py \
  ...
  --beta_dpo 5000 \
   --sdxl  \
  --caption_csv_file /share/imagereward_work/prompt_reconstruction/data/blip2_flan.csv \
  --output_dir="laion_high_res-937-1e-9" \
  --seed 937 \
  --train_data_subdir 0